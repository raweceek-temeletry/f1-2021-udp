...
client.on(PACKETS.motion,x => {
    ...
    console.log('float m_worldPositionX',x.m_carMotionData[myCar].m_worldPositionX);
    console.log('float m_worldPositionY',x.m_carMotionData[myCar].m_worldPositionY);
    console.log('float m_worldPositionZ',x.m_carMotionData[myCar].m_worldPositionZ);
    console.log('float m_worldVelocityX',x.m_carMotionData[myCar].m_worldVelocityX);
    console.log('float m_worldVelocityY',x.m_carMotionData[myCar].m_worldVelocityY);
    
    console.log('int16 m_worldForwardDirX',x.m_carMotionData[myCar].m_worldForwardDirX);
    console.log('int16 m_worldForwardDirY',x.m_carMotionData[myCar].m_worldForwardDirY);
    console.log('int16 m_worldForwardDirZ',x.m_carMotionData[myCar].m_worldForwardDirZ);
    console.log('int16 m_worldRightDirX',x.m_carMotionData[myCar].m_worldRightDirX);
    console.log('int16 m_worldRightDirY',x.m_carMotionData[myCar].m_worldRightDirY);
    console.log('int16 m_worldRightDirZ',x.m_carMotionData[myCar].m_worldRightDirZ);

    console.log('float m_gForceLateral',x.m_carMotionData[myCar].m_gForceLateral);
    console.log('float m_gForceLongitudinal',x.m_carMotionData[myCar].m_gForceLongitudinal);
    console.log('float m_gForceVertical',x.m_carMotionData[myCar].m_gForceVertical);
    ...
    console.log('float m_suspensionAcceleration FL',x.m_suspensionAcceleration[2]);
    console.log('float m_suspensionAcceleration FR',x.m_suspensionAcceleration[3]);
    console.log('float m_suspensionAcceleration RL',x.m_suspensionAcceleration[0]);
    console.log('float m_suspensionAcceleration RR',x.m_suspensionAcceleration[1]);
